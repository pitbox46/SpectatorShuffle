...
public class CommandAuto implements Command<CommandSource> {
    private static final Logger LOGGER = LogManager.getLogger();

    private static final CommandAuto CMD = new CommandAuto();
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        Spectate spectate = new Spectate(Spectate.Mode.AUTO);
